...
class BankAccount:
    ...
    def __init__(self, username, password, account_type, interest_rate):
        ...
        self.__bank_account_number = random.randint(10000000, 99999999) # this number should be unique
    ...
    def withdraw(self, amount, password):
        ...
        elif self.__account_type=="Timed_deposit_account":
        ...
        elif self.__account_type=="Overdraft_account":
...
if __name__ == "__main__":
    ...
    print("--------------------------------"*2)
    account2 = BankAccount("Jane", "123456", "Timed_deposit_account", 0.05)
    account2.deposit(100000)
    account2.withdraw(50000, "123456")
    account2.show_account_info()
    print("--------------------------------"*2)
    account3 = BankAccount("Jim", "123456", "Overdraft_account", 0.01)
...
class SavingAccount(BankAccount):
    def __init__(self, username, password, interest_rate):
        super().__init__(username, password, "Saving_account", interest_rate)
...
class TimedDepositAccount(BankAccount):
    def __init__(self, username, password, interest_rate, deposit_period):
        super().__init__(username, password, "Timed_deposit_account", interest_rate)
...
class OverdraftAccount(BankAccount):
    def __init__(self, username, password, interest_rate, overdraft_limit):
        super().__init__(username, password, "Overdraft_account", interest_rate)
